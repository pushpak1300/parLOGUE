                ...
                <div class="col-md-4">
                    <div class="card card-success">
                        ...
                        <div class="card-body text-center">
                            <img class="text-center" src="{{asset($photho->path)}}" height='400px' width="270px">
                        </div>
                        <!-- /.card-body -->
                    </div>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter Design Number" name="design_no">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="base_price" placeholder="Enter price">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="inc_price" placeholder="Enter price">
                                        </div>
                                    </div>

                                </div>
                                <input type="hidden" name="path" value={{$photho->path}}>
                                <div class="form-group">
